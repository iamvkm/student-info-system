...
if (isset($_POST['submit'])) {
     ...
     $qry= "INSERT INTO non_teaching "."(Id,Name,Sector)"." VALUES "
     ."('$idd','$name','$sec')";
          ...
          <div class="container d-flex justify-content-center">
               <div class="row">
                    <div class="login-page">
                         <div class="form">
                              <form class="login-form" action="addnonteach.php" method="post">
                                   <input type="text" placeholder="Identification Number" name="idd" required/>
                                   <input type="text" placeholder="Name" name="name" required/>
                                   <input type="text" placeholder="Sector" name="sec" required/>

                                   <button type="submit" class="btn btn-primary" name="submit" value="Submit">
                                   ADD STAFF INFORMATION</button>
