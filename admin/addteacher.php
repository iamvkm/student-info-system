...
if (isset($_POST['submit'])) {
     ...
     if ($name < 100000) {
          ...
          <script type="text/javascript">
               alert("Minimum salary is 1,00,000! It will be inserted!");
               window.open('admindash.php','_self');
          </script>
          <?php
          $sql = "CALL insertData('".$_POST["eid"]."','".$_POST["name"]."','".$_POST["salary"]."')";
     }
     $sql = "CALL insertData('".$_POST["eid"]."','".$_POST["name"]."','".$_POST["salary"]."')";
          ...
          <div class="container d-flex justify-content-center">
               <div class="row">
                    <div class="login-page">
                         <div class="form">
                              <form class="login-form" action="addteacher.php" method="post">
                                   ...
                                   ADD TEACHER INFORMATION</button>
