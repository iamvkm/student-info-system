<?php
     if (isset($_POST['submit'])) 
     {
          include('dbconn.php');
          $idd = $_POST['idd'];
          $qry = "SELECT * FROM `non_teaching` WHERE Id='$idd';";
          $run = mysqli_query($conn,$qry);

          if (mysqli_num_rows($run)!=1) echo "Invalid ID!";
          else {
                              ...
                              <div class="col-md-12 col-sm-12">
                                   <ul class="list-group list-group-flush">
                                     <li class="list-group-item">
                                        <h6>ID: <span style="font-family: Calibri;">
                                             <?php echo $data['Id'];?>
                                        </span></h6>
                                     </li>
                                      <li class="list-group-item">
                                      ...
                                      <li class="list-group-item">
                                        <h6>Sector: <span style="font-family: Calibri;">
     ...
     <body>
          <div class="container">
               ...
               <div id="sub">
                    ...
                    <div class="row">
                         <div class="col-md-12">
                              <form action="nonteach.php" method="post">
                                   <div class="input-group mb-3">
                                          <input type="text" class="form-control" placeholder="Enter Identification Number of staff" name="idd" required/>
