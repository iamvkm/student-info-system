<?php
     if (isset($_POST['submit'])) 
     {
          include('dbconn.php');
          $ei = $_POST['eid'];
          $qry = "SELECT * FROM `teachers` WHERE Eid='$ei';";
          $run = mysqli_query($conn,$qry);

          if (mysqli_num_rows($run)!=1) echo "Invalid EID!";
          else {
                              ...
                              <div class="col-md-12 col-sm-12">
                                   <ul class="list-group list-group-flush">
                                     <li class="list-group-item">
                                        <h6>EID: <span style="font-family: Calibri;">
                                             <?php echo $data['Eid'];?>
                                        </span></h6>
                                     </li>
                                      <li class="list-group-item">
                         ...
                         <div class="col-md-12">
                              <form action="teach.php" method="post">
                                   <div class="input-group mb-3">
                                          <input type="text" class="form-control" placeholder="Enter Employee ID of teacher" name="eid" required/>
